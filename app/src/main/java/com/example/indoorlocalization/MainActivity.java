...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    private final int NUM_PARTICLES = 10000; //total number of particles for particle filter

    //coordinates of the landmarks obtained from the floor map
...
//    private final ReentrantLock bufferLock = new ReentrantLock();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activity = (TextView) findViewById(R.id.textViewZ);//init text view
        image = (ImageView) findViewById(R.id.imageView); // init image view
    ...
    public void processsData() {
        ...
        //Thread to classify the activity
