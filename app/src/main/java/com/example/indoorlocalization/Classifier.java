...
import com.example.indoorlocalization.distanceAlgorithm.DistanceAlgorithm;
import com.example.indoorlocalization.distanceAlgorithm.EuclideanDistance;
...
public class Classifier {
    ...
    public Classifier(){
        ...
        splitRatio = 0.8;   //ratio of train:test data
        distanceAlgorithm = new EuclideanDistance();
        listDataPoint = new ArrayList<>(); //list of entire data
        listTrainData = new ArrayList<>();  //list of trained data
        listTestData = new ArrayList<>();   //list of test data
    ...
    // categories are mapped using the hash map
    private Category getMaxCategory(HashMap<Category, Integer> hashMap){
        ...
        return category;    //return th max category
    }
    ...
    public void classify(){
        ...
        accuracy /= listTestData.size();    //calculate accuracy
    }
